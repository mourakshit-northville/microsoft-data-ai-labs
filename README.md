...
A hands-on technical portfolio covering Microsoft Fabric, Azure Databricks, Real-Time Intelligence, OneLake, Fabric Warehouse, Power BI, Azure SQL, SQL Server, Copilot, Data Agents and enterprise AI patterns.
